...
## v0 (retroactive entry — 2026-07-10)

- **Authorship:** fully manual (single-author, single-reading-pass) — predates this task's
  two-LLM-agreement tooling. See `../recall-baseline-2026-07-10.md` § Golden-set methodology for
...
- **`corpus_pinned_at`:** backfilled to `2026-07-10` by this task (Phase 5 Step 1) — the
  rows were already human-verified against live documents on that date, per the baseline's
